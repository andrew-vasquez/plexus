...
export function HeroIntro() {
  ...
  return (
    <section className="relative">
      <div
        aria-hidden="true"
        className="hero-backdrop-layer pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.08),transparent_28%),linear-gradient(180deg,rgba(255,255,255,0.02),transparent_20%)]"
      />
      <div
        aria-hidden="true"
        className="hero-glow-layer pointer-events-none absolute inset-x-0 top-24 mx-auto h-[520px] max-w-5xl bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.07),transparent_58%)] blur-2xl sm:blur-3xl"
      />
      <div className="mx-auto max-w-7xl px-6 pt-28 md:pt-36 lg:px-10">
        <div className="mx-auto max-w-5xl text-center">
          ...
          >
            ...
            >
              <Link to="/studio/demo">Preview the workspace</Link>
            </Button>
          </AnimatedGroup>
        </div>
          ...
          <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[28px] border border-white/10 bg-[#0a0a0b] p-2 shadow-[0_30px_120px_-50px_rgba(0,0,0,0.95)]">
            <div className="relative rounded-[22px] border border-white/8 bg-[#121214] p-4 md:p-6">
              ...
              <div className="mt-6 grid auto-rows-min gap-4 lg:grid-cols-[1.2fr_0.8fr] lg:grid-rows-2">
                <div className="signal-intake-panel rounded-[18px] border border-white/8 bg-black/30 p-5">
                ...
                <div className="flex h-full flex-col rounded-[18px] border border-white/8 bg-black/30 p-5">
